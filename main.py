...
class TestPrivateApi:
    ...
    def setup_method(self):
        ...
        if cache_value is not None:
            ...
            response = requests.post(
                url_query_params("/login"), json=login_data, headers=self.headers
            )
    ...
    def test_get_profile(self):
        ...
        ), f"Failed to obtain the current user's personal information:{response.text}"
    ...
    def test_get_order_list(self):
        ...
        response = requests.get(
            url_query_params("/order/list", query), headers=self.headers
        )
